                ...
                <div class="checkout-form-box">
                    ...
                    <h2>Pago con tarjeta</h2>
                        <form action="/pagar.php" method="POST">
                            ...
                            <input type="text" name="card_number" placeholder="4242 4242 4242 4242" max="16" required>
                            <div class="card-icons">
                                <img src="img/pago/visa-classic-svgrepo-com.svg" alt="Visa">
                                <img src="img/pago/mastercard-full-svgrepo-com.svg" alt="MasterCard">
                            </div>
                            </div>
